...
function ProductDetails({ id }) {
    ...
    const handleBookTicket = async () => {
        ...
        const bookingData = {
            eventId: detailsData._id,

            eventTitle: detailsData.title,
            eventDate: detailsData.date,
            eventTime: detailsData.time,
            eventLocation: detailsData.location,
            priceAtBooking: detailsData.price,
